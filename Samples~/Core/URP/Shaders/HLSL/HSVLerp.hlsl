#ifndef GET_HSV_LERP_INCLUDED
#define GET_HSV_LERP_INCLUDED

inline half3 RGBToHSV(half3 In)
{
...
inline half3 HSVToRGB(half3 In)
{
...
inline void HSVLerp_float(half4 A, half4 B, half T, out half4 Out)
{
