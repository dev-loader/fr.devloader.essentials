...
{
    [AddComponentMenu("Devloader/Effects/Fade Material Properties")]
    public class FadeMaterialProperties : AbstractEffect
    {
        ...
        public struct MaterialVectorProperty
        {
            ...
            public Vector4 finalValue;

            public MaterialVectorProperty(string name, Vector4 initialValue, Vector4 finalValue)
            {
                this.name = name;
        ...
        [SerializeField] List<MaterialFloatProperty> _floatProperties = new List<MaterialFloatProperty>();
