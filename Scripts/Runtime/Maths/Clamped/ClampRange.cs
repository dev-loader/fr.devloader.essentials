...
{
    [System.Serializable, System.Obsolete("Use ClampedFloat instead")]
    public struct ClampRange
    {
        ...
        public ClampRange(float min, float max, float current)
        {
        ...
        public ClampRange Clamp(float value)
        {
            current = value;
            return this;
        }
        ...
        public ClampRange Lerp(float percent)
        {
            current = Mathf.Lerp(min, max, percent);
            return this;
        }

        public static implicit operator float(ClampRange clampedFloat) => clampedFloat._current;

        [System.Obsolete("Use current instead")]
        public float Current { get => _current; set => _current = Mathf.Clamp(value, Min, Max); }
        /// <summary>
        ...
        [System.Obsolete("Use length instead")]
        ...
        [System.Obsolete("Use max instead")]
        ...
        [System.Obsolete("Use min instead")]
