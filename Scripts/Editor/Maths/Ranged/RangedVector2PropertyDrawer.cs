...
{
    [CustomPropertyDrawer(typeof(RangedVector2))]
    public class RangedVector2PropertyDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            // Foldout avec affichage des valeurs min/max
            ...
            property.isExpanded = EditorGUI.BeginFoldoutHeaderGroup(
                foldoutRect,
                property.isExpanded,
                label + " [" + aProp.vector2Value + ".." + bProp.vector2Value + "]"
            );
            ...
            if (property.isExpanded)
            {
                ...
                currentValueProp.vector2Value = Vector2.Lerp(aProp.vector2Value, bProp.vector2Value, sliderValue);
        ...
        private void DrawCurrentLabel(Rect position, float lineHeight, float spacing)
        {
            ...
            Rect currentLabelRect = new Rect(position.x, y, 60, lineHeight);
