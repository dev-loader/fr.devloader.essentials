...
{
    [CustomPropertyDrawer(typeof(ClampedDouble))]
    public class ClampedDoublePropertyDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            CheckCurrent(ref current, min.doubleValue, max.doubleValue);
        }
        ...
        private void CheckCurrent(ref SerializedProperty current, double min, double max) => current.doubleValue = System.Math.Clamp(current.doubleValue, min, max);
        ...
        private void ShowProperties()
        {
            ...
            current.doubleValue = EditorGUI.Slider(currentValueRect, (float) current.doubleValue, (float) min.doubleValue, (float) max.doubleValue);
