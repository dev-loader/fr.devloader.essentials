...
namespace Devloader.Extensions
{
    public static class ComponentExtension
    {
        ...
        /// </summary>
        public static T[] FindAll<T>(bool inactiveToo = true, uint componentToCreate = 0, Transform parent = null) where T : Component
        {
            T[] components = Object.FindObjectsByType<T>(inactiveToo ? FindObjectsInactive.Include : FindObjectsInactive.Exclude);
        ...
        /// You can modify gameObjects parameters (like name or SetActive(bool)) using the returned components.
        /// </summary>
        public static Object[] FindAll(System.Type type, bool inactiveToo = true, uint componentToCreate = 0, Transform parent = null)
        {
            Object[] components = Object.FindObjectsByType(type, inactiveToo ? FindObjectsInactive.Include : FindObjectsInactive.Exclude);
        ...
        [System.Obsolete("Use FindAny instead")]
        public static T FindFirst<T>(bool inactiveToo = true, bool createIfNotExist = false, Transform parent = null) where T : Component => FindAny<T>(inactiveToo, createIfNotExist, parent);

        [System.Obsolete("Use FindAny instead")]
        public static Object FindFirst(System.Type type, bool inactiveToo = true, bool createIfNotExist = false, Transform parent = null) => FindAny(type, inactiveToo, createIfNotExist, parent);

        [System.Obsolete("Use FindAny instead")]
        public static bool TryFindFirst<T>(out T component, bool inactiveToo = true, bool createIfNotExist = false, Transform parent = null) where T : Component => TryFindAny(out component, inactiveToo, createIfNotExist, parent);
        ...
        /// You can modify gameObject parameters (like name or SetActive(bool)) using the returned component.gameObject.
        /// </summary>
        public static bool TryFindFirst(out Object component, System.Type type, bool inactiveToo = true, bool createIfNotExist = false, Transform parent = null) => TryFindAny(out component, type, inactiveToo, createIfNotExist, parent);
        ...
        /// </summary>
#if UNITY_6000_3_OR_NEWER
        public static Object[] FindSimilar(this Component component, bool inactiveToo = true) => FindAll(component.GetType(), inactiveToo);
#elif UNITY_6000_2_OR_NEWER
